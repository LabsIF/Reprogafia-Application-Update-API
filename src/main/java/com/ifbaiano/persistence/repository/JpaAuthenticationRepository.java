...
import com.ifbaiano.domain.usecase.AuthenticateUserUseCase;

@Repository
public class JpaAuthenticationRepository implements JpaRepository<User, Integer>, AuthenticateUserUseCase{
